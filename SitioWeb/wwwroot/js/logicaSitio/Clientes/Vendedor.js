...
function cargarTiposIdentificacion() {
    ...
    $.ajax({
        url: "/admin/vendedor/ObtenerTiposIdentificacionCombo", // Url
        type: "get",  // Verbo HTTP
    })
        // Se ejecuta si todo fue bien.
...
function cargarDataTable() {
    ...
    dataTable = $("#tblVendedores").DataTable({
        "ajax": {
            "url": "/admin/vendedor/ObtenerListaVendedores",
            "type": "GET",
            "datatype": "json"
        },
        "columns": [
            { "data": "id", "width": "5%" },
            { "data": "vendedor", "width": "45%" },
            ...
            { "data": "estado", "width": "10%" },
            {
                ...
                "render": function (data) {
                    return `<div class="text-center">
                            <a href='/Admin/Vendedor/VerRegistroVendedor/${data}' class='btn btn-success text-white' style='cursor:pointer;'>
