...
function LimpiarDatos() {
    ...
    $('#datosPersonaJuridica').hide();
    $("#tituloRep").hide();
    /* Cargar nuevamente el combo de provincias y tipos de identificacion*/
    cargarProvincias();
    cargarTiposIdentificacion();
    /*cierra el modal*/
    $('#modal-lg-registrar-comprador').modal('hide');


}

$("#btnCancelarRegistroComprador").click(function () {
    LimpiarDatos();
});
...
$(function () {
    $("#RegistrarCompradorForm").submit(function (e) {
        ...
        if (selectValor == 2) {
            ...
            var cedulaJu = $("#cedulaJuridica").val();
            var razonSocial = $("#razonSocial").val();
            var correoJu = $("#correoJuridica").val();
        ...
        frm.append("cedula", cedulaJu);
        frm.append("correo", correoJu);

        $.ajax({
            url: "/admin/comprador/RegistrarComprador", // Url
            data: frm,
            contentType: false,
            processData: false,
...
function cargarProvincias() {
    ...
    $.ajax({
        url: "/admin/comprador/ObtenerProvinciasCombo", // Url
        type: "get",  // Verbo HTTP
    })
        // Se ejecuta si todo fue bien.
...
function cargarTiposIdentificacion() {
    ...
    $.ajax({
        url: "/admin/comprador/ObtenerTiposIdentificacionCombo", // Url
        type: "get",  // Verbo HTTP
    })
        // Se ejecuta si todo fue bien.
...
$("#idProvincia").change(function () {
    ...
    $.ajax({
        url: "/admin/comprador/ObtenerCantonesCombo", // Url
...
$("#idCanton").change(function () {
    ...
    $.ajax({
        url: "/Admin/Comprador/ObtenerDistritosCombo", // Url
...
function cargarDataTable() {
    ...
    dataTable = $("#tblCompradores").DataTable({
        "ajax": {
            "url": "/admin/comprador/ObtenerListaCompradores",
            "type": "GET",
            "datatype": "json"
        },
        "columns": [
            { "data": "id", "width": "5%" },
            { "data": "comprador", "width": "45%" },
            ...
            { "data": "estado", "width": "10%" },
            {
                ...
                "render": function (data) {
                    return `<div class="text-center">
                            <a href='/Admin/Comprador/VerRegistroComprador/${data}'
                                class='btn btn-success text-white' style='cursor:pointer;'>
                            <i class="fa fa-wrench" aria-hidden="true"> Gestionar </i> 
                            </a>
                            </div>`;
                }, "width": "100%"
            }
