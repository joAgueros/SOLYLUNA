...
function cargarDataTable() {
    ...
    dataTable = $("#tblPropiedades").DataTable({
        "ajax": {
            "url": "/admin/propiedad/ObtenerListaPropiedadesEliminadas",
            "type": "GET",
            "datatype": "json"
        },
        "columns": [
            {
                ...
                "render": function (data) {
                    return `<div class="text-center">
                            ...
                            <a onclick=ActivarPropiedadEnListaPrincipal("/Admin/Propiedad/ActivarPropiedadEnListaPrincipal/${data}") class='btn btn-warning text-white m-1' style='cursor:pointer; width:100px;'>
...
function ActivarPropiedadEnListaPrincipal(url) {

    new swal({
        title: '¿Está seguro(a) de activar nuevamente la propiedad  en la lista principal?',
        text: "",
        type: 'warning',
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.success) {
                        ...
                        Swal.fire('Propiedad activada correctamente!', '', 'success')
                    }
                    else {
