...
$('#calendar').fullCalendar({
    ...
    events: '/Admin/AgendaOficina/GetCalendarEvents',
...
function sendAddEvent(event) {
    axios({
        method: 'post',
        url: '/Admin/AgendaOficina/AddEvent',
        data: {
            "Title": event.title,
        ...
        .then(res => {
            ...
            if (message == true) {
                ...
                alert(`Algo salió mal: ${data.eventId}`);
            }
        })
...
function sendUpdateEvent(event) {
    axios({
        method: 'post',
        url: '/Admin/AgendaOficina/UpdateEvent',
        data: {
...
$('#deleteEvent').click(() => {
    if (confirm(`Realmente quieres eliminar el evento "${currentEvent.title}"?`)) {
        axios({
            method: 'post',
            url: '/Admin/AgendaOficina/DeleteEvent',
            data: {
                "EventId": currentEvent.eventId
            }
        })
